    ...
    <div class="mx-auto max-w-6xl">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3">
            <?php foreach ($fasilitas as $fas): ?>
                <!-- Efek hover (hover:-translate-y-1 hover:shadow-xl) & class group telah dihapus -->
                <article class="overflow-hidden rounded-2xl bg-gradient-to-br from-green-50 via-white to-emerald-50 shadow-lg ring-1 ring-slate-200/80">
                    <div class="overflow-hidden">
                        <!-- Efek zoom gambar (group-hover:scale-105) telah dihapus -->
